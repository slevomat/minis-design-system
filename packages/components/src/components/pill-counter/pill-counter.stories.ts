...
export const Playground: Story = {
  ...
  render: (args) => html`
    <div style="display: inline-flex; padding: 8px; border-radius: 4px; background: var(--color-text-primary, #1a1a1a);">
...
export const HigherCounts: Story = {
  name: 'Higher counts',
  render: () => html`
    <div style="display: inline-flex; gap: 12px; align-items: center; padding: 8px; border-radius: 4px; background: var(--color-text-primary, #1a1a1a);">
