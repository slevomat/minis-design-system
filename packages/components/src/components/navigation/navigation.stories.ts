...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: `
<p><a href="https://www.figma.com/design/mfiAVMWkxiBRGnegjqLMNW/MiniS-DS?node-id=4135-3385&t=mtbinHhK8psdU6hq-11" target="_blank" rel="noopener noreferrer">Open in Figma ↗</a></p>
