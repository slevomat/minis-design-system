...
export const AllVariants: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'All six color variants side by side at the default 82×82 px size.',
      },
    },
  },
  render: () => html`
      ...
      ${['pink', 'yellow', 'blue', 'brand', 'green', 'summer'].map(
        (color) => html`
          <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
            ...
            <span style="font-size:12px;color:var(--color-text-secondary,#888)">${color}</span>
          </div>
        `,
      )}
    </div>
...
export const CheckColor: Story = {
  name: 'Custom Checkmark Color',
  parameters: {
    controls: { disable: true },
    docs: {
      description: {
  ...
  render: () => html`
    <div style="display:flex;gap:24px;align-items:center;flex-wrap:wrap">
      <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
        ...
        <span style="font-size:12px;color:var(--color-text-secondary,#888)">default — white check</span>
      </div>
      <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
        <minis-badge
          color="yellow"
          style="--badge-check-color: var(--color-branding-blue)"
        ></minis-badge>
        <span style="font-size:12px;color:var(--color-text-secondary,#888)">blue check</span>
      </div>
    </div>
  `,
};
